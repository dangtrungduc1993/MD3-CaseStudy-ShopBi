            ...
            <div class="row">
                <div class="col-md-3" style="margin-right: -15px;">
                    ...
                    <div class="categorycontent">
                        <ul>
                            <li> <a href="sach-kinh-te.html"> Thời trang nam</a><i class="fa fa-chevron-right float-right"></i>
                                <ul>
                                    <li class="liheader"><a href="#" class="header text-uppercase">Thời trang nam</a></li>
                                    <div class="content trai">
                                        <li><a href="#">Quần Shorts</a></li>
                                        <li><a href="#">Áo Thun & Áo Polo</a></li>
                            ...
                            <li><a href="#">Thời Trang Nữ </a><i class="fa fa-chevron-right float-right"></i>
                                <ul>
                                    ...
                                    <div class="content phai">
                                        <li><a href="#">Áo Thun & Áo Kiểu</a></li>
            ...
            <div class="noidung" style=" width: 100%;">
                <div class="row">
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center pb-2 bg-transparent pt-4">
                        <h1 class="header text-uppercase" style="font-weight: 400;">FLASH SALE</h1>
            ...
            <div class="noidung bg-white" style=" width: 100%;">
                <div class="row">
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center pb-2 bg-light">
                        <h2 class="header text-uppercase" style="font-weight: 400;">XU HƯỚNG TÌM KIẾM</h2>
        ...
        <div class="container">
            <div class="noidung bg-white" style=" width: 100%;">
                <div class="row">
                    <!--header-->
                    <div class="col-12 d-flex justify-content-between align-items-center pb-2 bg-light">
                        <h2 class="header text-uppercase" style="font-weight: 400;">TÌM KIẾM HÀNG ĐẦU</h2>
                        <a href="#" class="btn btn-warning btn-sm text-white">Xem tất cả</a>
                    </div>
                </div>
                <div class="khoisanpham">
