                ...
                <div class="col-md-9 px-0">
                    <div id="carouselId" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <a href="#"><img src="front/images/neu-toi-biet-duoc-khi-20-full-banner.jpg"
                                                 class="img-fluid"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                           data-toggle="tooltip" data-placement="bottom" title="Lịch Sử Thế Giới">
                            <img class="card-img-top anh" src="front/images/lich-su-the-gioi.jpg"
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                           ...
                           title="Combo Mẹ Con Sư Tử - Bồ Tát Ngàn Tay Ngàn Mắt">
                            <img class="card-img-top anh"
                                 src="front/images/combo-me-con-su-tu-bo-tat-ngan-tay-ngan-mat.jpg"
                        ...
                        <div class="card">
                            <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                               ...
                               title="Suối nguồn” và cái tôi hiện sinh trong từng cá thể">
                                <img class="card-img-top anh"
                                     src="front/images/suoi-nguon-va-cai-toi-trong-tung-ca-the.jpg"
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        <img src="front/images/icon-books.png" alt="icon-books">
                        <div class="noidung">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        <img src="front/images/icon-ship.png" alt="icon-ship">
                        <div class="noidung">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        <img src="front/images/icon-gift.png" alt="icon-gift">
                        <div class="noidung">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        <img src="front/images/icon-return.png" alt="icon-return">
                        <div class="noidung">
